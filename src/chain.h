 ...
 */
static constexpr int64_t MAX_FUTURE_BLOCK_TIME = 24 * 60 * 60;
...
// BITSZ
    // BITSZ: money supply related block index fields
    int64_t nMint{0};
    int64_t nMoneySupply{0};

    // BITSZ: proof-of-stake related block index fields
    unsigned int nFlags{0};  // BITSZ: block index flags
    enum
    {
