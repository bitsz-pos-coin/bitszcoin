...
#define QAPP_ORG_NAME "BITSZ"
#define QAPP_ORG_DOMAIN "BITSZ.net"
#define QAPP_APP_NAME_DEFAULT "BITSZ-Qt"
#define QAPP_APP_NAME_TESTNET "BITSZ-Qt-testnet"
#define QAPP_APP_NAME_REGTEST "BITSZ-Qt-regtest"
