...
<context>
    ...
    <message>
        <source>These are your BITSZ addresses for receiving payments. It is recommended to use a new receiving address for each transaction.</source>
...
<context>
    ...
    <message>
        <source>%1 will close now to finish the encryption process. Remember that encrypting your wallet cannot fully protect your BITSZs from being stolen by malware infecting your computer.</source>
...
<context>
    ...
    <message>
        <source>Open a BITSZ: URI or payment request</source>
...
<context>
    ...
    <message>
        <source>Paying only the minimum fee is just fine as long as there is less transaction volume than space in the blocks. But be aware that this can end up in a never confirming transaction once there is more demand for BITSZ transactions than the network can process.</source>
