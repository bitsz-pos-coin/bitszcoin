    ...
    platformStyle(_platformStyle)
{
    ...
    QVBoxLayout *vboxStaking = new QVBoxLayout();
    mintingView = new StakingView(this);
    vboxStaking->addWidget(mintingView);
    mintingPage->setLayout(vboxStaking);
