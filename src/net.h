...
/** BITSZ: Number of consecutive PoS headers are allowed from a single peer. Used to prevent out of memory attack. */
...
public:
    ...
    uint256 hashCheckpointKnown; // BITSZ: known sent sync-checkpoint
    ...
    // BITSZ: used to detect branch switches
