...
const char * const BITCOIN_CONF_FILENAME = "BITSZ.conf";
...
{
    // Windows < Vista: C:\Documents and Settings\Username\Application Data\BITSZ
    // Windows >= Vista: C:\Users\Username\AppData\Roaming\BITSZ
    // Mac: ~/Library/Application Support/BITSZ
    // Unix: ~/.BITSZ
#ifdef WIN32
    // Windows
    return GetSpecialFolderPath(CSIDL_APPDATA) / "BITSZ";
#else
    fs::path pathRet;
...
#ifdef MAC_OSX
    // Mac
    return pathRet / "Library/Application Support/BITSZ";
#else
    // Unix
    return pathRet / ".BITSZ";
#endif
#endif
}
